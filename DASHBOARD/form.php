...
<div id="registration">
 ...
 <form id="RegisterUserForm" action="dashboard.php" method="post">
 	<fieldset>
         <p>
            <label for="name">Name</label>
            <input id="name" name="name1" type="text" class="text" value="" />
         </p>
		...
		<p>
            ...
            <input id="name" name="name2" type="text" class="text" value="" />
         </p>
		 <p>
            <label for="name">your projects</label>
            <input id="name" name="name3" type="text" class="text" value="" />
         </p>
		 
        
        <p>
			<input type="submit" value="Submit" style="align:right"></input>
         </p>
 	</fieldset>
